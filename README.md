...
Some other, more opinionated features are present as well, such as configuration files for editorconfig, eslint, nvm and prettier.
...
This is the default folder for your SCSS files. While using `<style lang="scss">` inside your components works fine, having the possibility to decouple your styles is ecouraged.
